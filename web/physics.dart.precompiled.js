...
["box2", "../math/box2.dart", , K, {
  ...
  Box2: {
    ...
    static: {Box2$: function(p, v) {
        var t1 = new K.Box2(null, null, null);
        t1.Box2$2(p, v);
        return t1;
      }}
  }
}],
["", "renderer/canvasrenderer.dart", , Q, {
  "": "",
  CanvasRenderer: {
    "": "Renderer;TAU,_canvasrenderer$_canvas,_context",
    drawCircle$3: function(p, radius, color) {
      var t1, t2, t3, t4;
      t1 = p.x;
      t2 = this._canvasrenderer$_canvas.clientHeight;
      t3 = p.y;
      if (typeof t2 !== "number")
        return t2.$sub();
      t4 = this._context;
    ...
    drawPath$4: function(points, $close, colorEven, colorOdd) {
      var $length, t1, i, t2, t3, t4, t5, i0, t6, t7;
      this._context.strokeStyle = colorOdd;
      $length = points.length;
      $length = $close ? $length : $length - 1;
      for (t1 = this._canvasrenderer$_canvas, i = 0; i < $length; i = i0) {
        t2 = points.length;
        if (i >= t2)
        ...
        t7.beginPath();
        t7.lineWidth = 1;
        t7.strokeStyle = C.JSInt_methods.$mod(i, 2) === 0 ? colorEven : colorOdd;
        t7.moveTo(t4, t5 - t3);
        t7.lineTo(t2, t5 - t6);
        t7.stroke();
      }
...
["equations", "../math/quadric.dart", , B, {
  "": "",
  Quadric: {
    "": "Object;_equations$_a,_equations$_b,_c,_d,_x,_y",
    get$x: function(_) {
      return this._x;
    },
    get$y: function(_) {
    ...
    Quadric$3: function(_a, _b, _c) {
      var t1, t2, t3, d, k;
      t1 = this._equations$_a;
      if (t1 !== 0) {
        t2 = this._equations$_b;
        if (typeof t2 !== "number")
          return t2.$mul();
        if (typeof t1 !== "number")
          return H.iae(t1);
...
["math.vec2", "../math/vec2.dart", , G, {
  ...
  Vec2: {
    ...
    $add: function(_, v) {
      ...
      if (typeof t2 !== "number")
        return H.iae(t2);
      return new G.Vec2(t1 + t3, t4 + t2);
    },
    $sub: function(_, v) {
      return new G.Vec2(this.x - v.x, this.y - v.y);
    },
    $mul: function(_, f) {
...
["particle", "physics/particle.dart", , D, {
  ...
  Particle: {
    ...
    AddForce$1: function(force) {
      ...
      if (this._mass !== 1 / 0) {
        t1 = this._force;
        this._force = t1.$add(t1, force);
      }
    },
    Integrate$1: function(dt) {
      var t1, t2, t3, oldPosition, t4;
      t1 = this._mass;
      if (t1 === 1 / 0)
        return;
      t2 = this._force;
...
["particle.create", "tools/particle.create.dart", , B, {
  ...
  CreateParticle: {
    ...
    Activate$0: function() {
      ...
      t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.CreateParticle_Activate_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t2._tryResume$0();
      this._onMouseDownStream = t2;
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousemove._eventType, false), [null]);
      t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new B.CreateParticle_Activate_closure0(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t2._tryResume$0();
      this._onMouseMoveStream = t2;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mouseup._eventType, false), [null]);
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new B.CreateParticle_Activate_closure1(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
      this._onMouseUpStream = t1;
    },
  ...
  CreateParticle_Activate_closure: {
    ...
    call$1: function(e) {
      ...
      x = t2.get$layer(e).x;
      x.toString;
      t3 = t1._create$_canvas.clientHeight;
  ...
  CreateParticle_Activate_closure0: {
    "": "Closure:11;this_1",
    call$1: function(e) {
      ...
      t3 = t2.get$layer(e).x;
      t3.toString;
      t4 = t1._create$_canvas.clientHeight;
      t5 = H.setRuntimeTypeInfo(new P.Point(e.layerX, e.layerY), [null]).y;
      t5.toString;
      if (typeof t4 !== "number")
        return t4.$sub();
      if (typeof t5 !== "number")
        return H.iae(t5);
      point = new G.Vec2(t3, t4 - t5);
      t2 = t2.get$ctrlKey(e) === true ? 1 / 0 : 1;
      t3 = t1._particle;
      if (t3 != null) {
        t3._mass = t2;
  ...
  CreateParticle_Activate_closure1: {
    "": "Closure:11;this_2",
    call$1: function(e) {
      var t1, t2, t3;
      t1 = this.this_2;
      t2 = J.get$ctrlKey$x(e) === true ? 1 / 0 : 1;
      t3 = t1._particle;
      if (t3 != null) {
        t3._mass = t2;
        t1._create$_particles.push(t3);
      }
      t1._particle = null;
      return;
    }
...
["particle.delete", "tools/particle.delete.dart", , A, {
  ...
  DeleteParticle: {
    ...
    Deactivate$0: function() {
      this._$delete$_onMouseMoveStream.cancel$0();
    ...
    Activate$0: function() {
      ...
      t1.toString;
      t2 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_mousemove._eventType, false), [null]);
      t2 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._target, t2._eventType, W._wrapZone(new A.DeleteParticle_Activate_closure(this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)]);
      t2._tryResume$0();
      this._$delete$_onMouseMoveStream = t2;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false), [null]);
      t1 = H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new A.DeleteParticle_Activate_closure0(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)]);
      t1._tryResume$0();
  ...
  DeleteParticle_Activate_closure0: {
    "": "Closure:11;this_1",
    call$1: function(e) {
      return this.this_1._onClick$1(e);
    }
  }
}],
...
["physicsdemo", "physics.dart", , V, {
  ...
  appLoop: [function(delta) {
    ...
    t1 = $.renderer;
    t2 = t1._context;
    t1 = t1._canvasrenderer$_canvas;
    t2.clearRect(0, 0, t1.clientWidth, t1.clientHeight);
    $.get$notes().textContent = "" + $.get$particles().length + " particle(s)";
    t1 = $.get$colliding();
...
function dart_precompiled($collectedClasses) {
  ...
  function Box2(_min, _max, _points) {
    this._min = _min;
    this._max = _max;
    this._points = _points;
  }
  Box2.builtin$cls = "Box2";
  if (!"name" in Box2)
    Box2.name = "Box2";
  $desc = $collectedClasses.Box2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Box2.prototype = $desc;
  Box2.prototype.get$_min = function() {
    return this._min;
  };
  function CanvasRenderer(TAU, _canvasrenderer$_canvas, _context) {
    this.TAU = TAU;
    this._canvasrenderer$_canvas = _canvasrenderer$_canvas;
  ...
  function SeparateContact(_contact$_dt, _rv_dot_cn, _cn, _rv) {
    this._contact$_dt = _contact$_dt;
    this._rv_dot_cn = _rv_dot_cn;
    this._cn = _cn;
    this._rv = _rv;
  }
  SeparateContact.builtin$cls = "SeparateContact";
  if (!"name" in SeparateContact)
    SeparateContact.name = "SeparateContact";
  $desc = $collectedClasses.SeparateContact;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SeparateContact.prototype = $desc;
  function RestingContact(_contact$_dt, _rv_dot_cn, _cn, _rv) {
    this._contact$_dt = _contact$_dt;
    this._rv_dot_cn = _rv_dot_cn;
    this._cn = _cn;
    this._rv = _rv;
  }
  RestingContact.builtin$cls = "RestingContact";
  if (!"name" in RestingContact)
    RestingContact.name = "RestingContact";
  $desc = $collectedClasses.RestingContact;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RestingContact.prototype = $desc;
  function CollidingContact(_contact$_dt, _rv_dot_cn, _cn, _rv) {
    this._contact$_dt = _contact$_dt;
    this._rv_dot_cn = _rv_dot_cn;
    this._cn = _cn;
    this._rv = _rv;
  }
  CollidingContact.builtin$cls = "CollidingContact";
  if (!"name" in CollidingContact)
    CollidingContact.name = "CollidingContact";
  $desc = $collectedClasses.CollidingContact;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CollidingContact.prototype = $desc;
  function Contact() {
  }
  ...
  function Quadric(_equations$_a, _equations$_b, _c, _d, _x, _y) {
    this._equations$_a = _equations$_a;
    this._equations$_b = _equations$_b;
    this._c = _c;
    this._d = _d;
    this._x = _x;
    this._y = _y;
  }
  Quadric.builtin$cls = "Quadric";
  if (!"name" in Quadric)
    Quadric.name = "Quadric";
  $desc = $collectedClasses.Quadric;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Quadric.prototype = $desc;
  function Force() {
  }
  ...
  function Damping(_factor) {
    this._factor = _factor;
  }
  Damping.builtin$cls = "Damping";
  if (!"name" in Damping)
    Damping.name = "Damping";
  $desc = $collectedClasses.Damping;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Damping.prototype = $desc;
  function Gravity(_gavity$_force) {
    this._gavity$_force = _gavity$_force;
  }
  Gravity.builtin$cls = "Gravity";
  if (!"name" in Gravity)
    Gravity.name = "Gravity";
  $desc = $collectedClasses.Gravity;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function Particle(_position, _velocity, _acceleration, _force, _velocityBox, _largeBox, _damping, _radius, _mass, _resting) {
    this._position = _position;
    this._velocity = _velocity;
    this._acceleration = _acceleration;
    this._force = _force;
    this._velocityBox = _velocityBox;
    this._largeBox = _largeBox;
    this._damping = _damping;
    this._radius = _radius;
    this._mass = _mass;
    this._resting = _resting;
  }
  ...
  function CreateParticle(_alpha, _path, _create$_particles, _particle, _create$_canvas, _velocityFactor, _mouseEvent, _onMouseDownStream, _onMouseMoveStream, _onMouseUpStream) {
    this._alpha = _alpha;
    this._path = _path;
    this._create$_particles = _create$_particles;
    this._particle = _particle;
    this._create$_canvas = _create$_canvas;
    this._velocityFactor = _velocityFactor;
    this._mouseEvent = _mouseEvent;
    this._onMouseDownStream = _onMouseDownStream;
    this._onMouseMoveStream = _onMouseMoveStream;
    this._onMouseUpStream = _onMouseUpStream;
  }
  CreateParticle.builtin$cls = "CreateParticle";
  if (!"name" in CreateParticle)
    CreateParticle.name = "CreateParticle";
  $desc = $collectedClasses.CreateParticle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CreateParticle.prototype = $desc;
  function CreateParticle_Activate_closure(this_0) {
    this.this_0 = this_0;
  }
  CreateParticle_Activate_closure.builtin$cls = "CreateParticle_Activate_closure";
  if (!"name" in CreateParticle_Activate_closure)
    CreateParticle_Activate_closure.name = "CreateParticle_Activate_closure";
  $desc = $collectedClasses.CreateParticle_Activate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CreateParticle_Activate_closure.prototype = $desc;
  function CreateParticle_Activate_closure0(this_1) {
    this.this_1 = this_1;
  }
  CreateParticle_Activate_closure0.builtin$cls = "CreateParticle_Activate_closure0";
  if (!"name" in CreateParticle_Activate_closure0)
    CreateParticle_Activate_closure0.name = "CreateParticle_Activate_closure0";
  $desc = $collectedClasses.CreateParticle_Activate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CreateParticle_Activate_closure0.prototype = $desc;
  function CreateParticle_Activate_closure1(this_2) {
    this.this_2 = this_2;
  }
  CreateParticle_Activate_closure1.builtin$cls = "CreateParticle_Activate_closure1";
  if (!"name" in CreateParticle_Activate_closure1)
    CreateParticle_Activate_closure1.name = "CreateParticle_Activate_closure1";
  $desc = $collectedClasses.CreateParticle_Activate_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CreateParticle_Activate_closure1.prototype = $desc;
  function DeleteParticle(_canvas, _highlighted, _particles, _constraints, _$delete$_mouseEvent, _$delete$_onMouseMoveStream, _onClickStream) {
    this._canvas = _canvas;
    this._highlighted = _highlighted;
    this._particles = _particles;
    this._constraints = _constraints;
    this._$delete$_mouseEvent = _$delete$_mouseEvent;
    this._$delete$_onMouseMoveStream = _$delete$_onMouseMoveStream;
    this._onClickStream = _onClickStream;
  }
  DeleteParticle.builtin$cls = "DeleteParticle";
  if (!"name" in DeleteParticle)
    DeleteParticle.name = "DeleteParticle";
  $desc = $collectedClasses.DeleteParticle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DeleteParticle.prototype = $desc;
  function DeleteParticle_Activate_closure(this_0) {
    this.this_0 = this_0;
  }
  DeleteParticle_Activate_closure.builtin$cls = "DeleteParticle_Activate_closure";
  if (!"name" in DeleteParticle_Activate_closure)
    DeleteParticle_Activate_closure.name = "DeleteParticle_Activate_closure";
  $desc = $collectedClasses.DeleteParticle_Activate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DeleteParticle_Activate_closure.prototype = $desc;
  function DeleteParticle_Activate_closure0(this_1) {
    this.this_1 = this_1;
  }
  DeleteParticle_Activate_closure0.builtin$cls = "DeleteParticle_Activate_closure0";
  if (!"name" in DeleteParticle_Activate_closure0)
    DeleteParticle_Activate_closure0.name = "DeleteParticle_Activate_closure0";
  $desc = $collectedClasses.DeleteParticle_Activate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DeleteParticle_Activate_closure0.prototype = $desc;
  function SelectParticle(_select$_canvas, _output, _select$_highlighted, _select$_particles, _tracked, _select$_mouseEvent, _select$_onMouseMoveStream, _select$_onClickStream) {
    this._select$_canvas = _select$_canvas;
    this._output = _output;
    this._select$_highlighted = _select$_highlighted;
    this._select$_particles = _select$_particles;
    this._tracked = _tracked;
    this._select$_mouseEvent = _select$_mouseEvent;
    this._select$_onMouseMoveStream = _select$_onMouseMoveStream;
    this._select$_onClickStream = _select$_onClickStream;
  }
  SelectParticle.builtin$cls = "SelectParticle";
  if (!"name" in SelectParticle)
    SelectParticle.name = "SelectParticle";
  $desc = $collectedClasses.SelectParticle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SelectParticle.prototype = $desc;
  function SelectParticle_Activate_closure(this_0) {
    this.this_0 = this_0;
  }
  SelectParticle_Activate_closure.builtin$cls = "SelectParticle_Activate_closure";
  if (!"name" in SelectParticle_Activate_closure)
    SelectParticle_Activate_closure.name = "SelectParticle_Activate_closure";
  $desc = $collectedClasses.SelectParticle_Activate_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SelectParticle_Activate_closure.prototype = $desc;
  function SelectParticle_Activate_closure0(this_1) {
    this.this_1 = this_1;
  }
  SelectParticle_Activate_closure0.builtin$cls = "SelectParticle_Activate_closure0";
  if (!"name" in SelectParticle_Activate_closure0)
    SelectParticle_Activate_closure0.name = "SelectParticle_Activate_closure0";
  $desc = $collectedClasses.SelectParticle_Activate_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  SelectParticle_Activate_closure0.prototype = $desc;
  function CollisionPair(_phx_collision_pair$_a, _phx_collision_pair$_b, _contact) {
    this._phx_collision_pair$_a = _phx_collision_pair$_a;
    this._phx_collision_pair$_b = _phx_collision_pair$_b;
    this._contact = _contact;
  }
  CollisionPair.builtin$cls = "CollisionPair";
  if (!"name" in CollisionPair)
    CollisionPair.name = "CollisionPair";
  $desc = $collectedClasses.CollisionPair;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CollisionPair.prototype = $desc;
  function CollisionMap(Particles, _phx_collisions$_constraints, _particlesCount, _phx_collisions$_index, _pairs, _particlePairs) {
    this.Particles = Particles;
    this._phx_collisions$_constraints = _phx_collisions$_constraints;
    this._particlesCount = _particlesCount;
    this._phx_collisions$_index = _phx_collisions$_index;
    this._pairs = _pairs;
    this._particlePairs = _particlePairs;
  }
  CollisionMap.builtin$cls = "CollisionMap";
  if (!"name" in CollisionMap)
    CollisionMap.name = "CollisionMap";
  $desc = $collectedClasses.CollisionMap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CollisionMap.prototype = $desc;
  function Constraint() {
  }
  Constraint.builtin$cls = "Constraint";
  if (!"name" in Constraint)
    Constraint.name = "Constraint";
  $desc = $collectedClasses.Constraint;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Constraint.prototype = $desc;
  function Distance(_distance, _ia, _ib, order, _a, _b) {
  ...
  function Simulation(_worldWidth, _worldHeight, _dt, _forces, _collisionMap, gravityForce) {
    this._worldWidth = _worldWidth;
    this._worldHeight = _worldHeight;
    this._dt = _dt;
    this._forces = _forces;
    this._collisionMap = _collisionMap;
