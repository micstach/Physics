...
function dart_precompiled($collectedClasses) {
  ...
  function Contact(_a, _b, _dt, _resting) {
    this._a = _a;
    this._b = _b;
    this._dt = _dt;
  ...
  function Particle(_particle$_position, _velocity, _acceleration, _force, _box, _damping, _radius, _mass) {
    this._particle$_position = _particle$_position;
  ...
  function CreateParticle(_alpha, _path, _create$_particles, _particle, _create$_canvas, _velocityFactor, _onMouseDownStream, _onMouseMoveStream, _onMouseUpStream) {
    this._alpha = _alpha;
    this._path = _path;
  ...
  function CollisionPair(_contact) {
  ...
  function CollisionMap(_particlesCount, _phx_collisions$_index, _pairs, _particlePairs) {
  ...
  function Simulation(forces, _collisionMap, gravityForce, _worldWidth, _worldHeight) {
    this.forces = forces;
